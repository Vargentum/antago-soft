...
$(function(){
    $('.b-list__element .button').each(function(){
        $(this).click(function(){
            var value = Math.floor( Math.random( ) * (100 - 10 + 1) ) + 10;
            $(this).prev().children('.b-progress_bar').children('.percent').html(value);
            $(this).prev().children('.b-progress_bar').children('.bar').css('width', value+'%');
        });
    });
});